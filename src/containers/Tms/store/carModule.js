...
export default {
    ...
    getters: {
        [carConst.Billing_G_GET_NAVTABDATA](state,getters){
            return state.navTabData
        }
    },
    mutations: {
        [carConst.Billing_M_UPDATE_NAVTABDATA](state, payload){
        ...
        [carConst.Billing_M_PUSH_NAVTABDATA] (state, payload) {
            state.navTabData.push(payload)
        },
        [carConst.Billing_M_DELETE_NAVTABDATA] (state, payload) {
