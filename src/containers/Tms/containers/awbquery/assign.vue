<template>
		<div>
				...
				<el-table :data="data"  ref="allTable"   border show-summary  style="width: 100%; margin-top: 16px;">
                    ...
                    <el-table-column  prop="waybill.goodsName" label="货物名称" width="85"></el-table-column>
                    ...
                    <el-table-column  prop="collectPayment" label="代收货费" width="90"></el-table-column>
                    ...
                    <el-table-column  prop="waybill.deliverySendTime" label="预计到达日期" width="120"></el-table-column>
                    <el-table-column  prop="waybill.orderDate" label="录单日期" width="90"></el-table-column>
                    <el-table-column  prop="waybill.acceptDate" label="接单日期" width="90"></el-table-column>
                    <el-table-column  prop="waybill.storageTime" label="入库时间" width="90"></el-table-column>
                    <el-table-column  prop="waybill.storageHours" label="在库时长(小时)" width="120"></el-table-column>
                    <el-table-column  prop="waybill.pushTime" label="指派时间" width="90"></el-table-column>
                    <el-table-column  prop="waybill.pushDotId" label="指派网点" width="90"></el-table-column>
                     <el-table-column prop="waybill.pushType" label="指派类型" width="90"></el-table-column>
...
//			clickdata(){
//					this.$http.post('http://192.168.177.152:8989/tms-web/distributionWaybillQuery/getAssignedWaybill',{
//
//					  "currentDotId": 0,
//					  "currentPage": 0,
//					  "endAcceptDate": 0,
