            ...
            <div class="dispatcherAddContent">
                ...
                <div class="waybillDeatil">
                    ...
                    <div class="waybillDetailContentSpread">
                        <el-table :data="waybillTableData" border
                            ...
                            <el-table-column prop="waybill.customerOrderCode" label="客户单号" header-align="center" width="130">

                            </el-table-column>
                            <el-table-column prop="" label="线路顺序" header-align="center" width="130">
                            </el-table-column>
                            <el-table-column prop="waybill.deliverySendTime" label="执行任务" header-align="center" width="130">
