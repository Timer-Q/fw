<template>
    <div v-if='isCache' class="b2b">
        <Tabs class="temporary-tabs" type="card" v-model="selectTab.tag" @tab-click="tabClick" @tab-remove="removeTab">
            <TabPane label="商品审核管理-列表" :key="tag" :name="tag">
                <tabs-temp></tabs-temp>
            </TabPane>
        ...
        <dialog-temp></dialog-temp>
    </div>
</template>
<script>
    import oneLevelTabMixins from '@/mixins/oneLevelTabMixins.js'
    import twoLevelTabMixins from '@/mixins/twoLevelTabMixins.js'
    import tabsTemp from '@B2B/containers/commodity/CommodityExamineTabsContainer.vue'
    import commodityDetail from '@B2B/containers/commodity/CommodityDetailContainer.vue'
    import dialogTemp from '@B2B/containers/commodity/DialogContainer.vue'
    ...
    export default{
        ...
        components: {
            tabsTemp,commodityDetail,dialogTemp
        },
        mounted(){
            const _this = this
            ...
            // 添加tab
            this.$root.bus.$on('commodityExamineDetailTabAdd', function(addTabObj) {
            ...
            // 关闭tab
            this.$root.bus.$on('commodityExamineDetailTabClose', function(removeTabObj) {
