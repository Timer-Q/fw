<template>
    <div class="admin-template">
     <div class="projection">
        <Button class="public-function-btn" @click="updateAdmin">保存</Button>
    ...
    <div class="form-wrapper">
        <el-form :inline="true" :model="formData"  class="demo-form-inline" ref="ruleForm" label-width="83px">
            <el-form-item label="编码" v-show="false" class="precent23" label-width="83px">
                <el-input v-model="formData.id" v-show="false" placeholder="id" size="small" :readonly="formReadOnly"></el-input>
            </el-form-item>
...
<script>
    const USERID = 11
    import { updateGroup,getIndustryType,queryGroupById } from '@Permission/services/groupService.js'
    ...
    export default {
        ...
        methods: {
            ...
            async updateAdmin() {
                ...
                this.formData.updateUser=USERID
                var res = await updateGroup(this.formData)
                console.log(res,555)
                 if (res.status === 200) {
