            ...
            <div class="mainContainer clearfix">
                ...
                <div class="newContent">
                    <div class="newContentBox ">
                        ...
                        <div class="groupL">
                            <div class="groupL-p">
                                ...
                                <el-input placeholder="请输入" v-model="decimalDigitValue" :disabled='decimalDigit'></el-input>
                            </div>
                            <div class="groupL-p">
                    ...
                    <div class="dropdownListValue" v-show="isShow">
                        ...
                        <div>
                            <el-button class="newButton">上移</el-button>
                            <el-button class="newButton">下移</el-button>
                        </div>
            ...
            request(){//整理数据发送请求
                ...
                if(this.inputModeValue === 2){
                    this.tableData.forEach( item => {
                        ...
                        newItem.orgId = this.SubordinateOrganizeValue
                ...
                let url = `http://10.12.31.54:8412/crm-web/items/saveContractItemLibrary`
                this.$http.post(url, newItemMessage, {
                    headers: {
                    ...
                    .then(function (response) {
                        ...
                        if(response.data.status.statusCode === 0){
                            ...
                            alert('保存失败！' + response.data.status.statusReason)
                        }
                    })
