        ...
        <div class="modal-div clearfix">
            <div>
                <div class="btnGroup btnGroup1">
                    <a href="javascript:;" class="add-btn" @click="clickByEdit('add', 'itemLibraryGroupAdd')">新增</a>
                </div>
                <div class="btnGroup btnGroup1">
...
//            },
            deleteJudge(){//删除验证
                if(this.currentRow.org === '全局' && this.userGroupOrgId === 2){
...
//                }
            ...
            modifyItem() {//修改
                ...
                if (this.currentRow) {
                    ...
                    this.clickByEdit('update', 'itemLibraryGroupModify')
                } else {
            ...
            changeUseStatus(isUse) {//启停用
                ...
                let url = `${this.urlForward}items/setItemLibraryStatus/${this.currentRow.id}?orgId=${this.userGroupOrgId}&status=${status}&updateUser=${10001}`
                axios.get(url, {
                    headers: {
                        'Content-Type': 'application/json;charset=utf-8'
                    }
...
//                            this.search()
            ...
            initialOrg(){//初始化所属组织
                let url = `${this.urlForward}enum/getAllOrg?orgId=${this.userGroupOrgId}`
                //http://192.168.170.201:9015/crm-contract-server/enum/getAllOrg?name=2
                axios.get(url, {
                    headers: {
                        'Content-Type': 'application/json;charset=utf-8'
