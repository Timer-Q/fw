                    ...
                    <div class="newContentBox ">
                        ...
                        <div class="groupL">
                            <div class="groupL-p">
                                ...
                                <Input placeholder=""  type="number" min="0" max="9"
                                       @change="valChange" v-model="decimalPlace" :disabled='decimalDigit'></Input>
                            </div>
                            <div class="groupL-p">
                ...
                axios.post(url, modifyItemMessage, {
                    ...
                    .then( (response) => {
                        ...
                        if (data.result === 1) {
                            this.$message('修改成功！')
                            setTimeout(() => {
                                this.removeTab('crm_itemLibraryOverallMain_itemLibraryOverallModify')
                            }, 3000)
                        }else {
