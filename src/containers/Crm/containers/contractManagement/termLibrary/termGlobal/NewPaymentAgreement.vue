                    ...
                    <div class="newContentBoxMini">
                        ...
                        <div class="groupL">
                            ...
                            <div class="groupL-p">
                                ...
                                <i class="star-icon">*</i>
                                <el-select @change="businessTypeChange" v-model="businessType" placeholder="请选择"><!--@visible-change="getInitEnums('getBusiTypeList')" -->
                                    <el-option
                                        v-for="item in businessTypeOptions"
                                        :key="item.value"
                                        :label="item.label"
                        ...
                        <div class="groupL">
                            ...
                            <div class="groupL-p">
                                ...
                                <i class="star-icon">*</i>
                                <el-select @change="newAccountInitialDayChange" v-model="newAccountInitialDay" placeholder="请选择"><!--@visible-change="getInitEnums('getLiZhangCountParams', )" -->
                                    <el-option
                        ...
                        <div class="groupL">
                            ...
                            <div class="groupL-p">
                                ...
                                <i class="star-icon">*</i>
                                <el-select v-model="newAccountConfirm" @change="newAccountConfirmChange" filterable placeholder="请选择">
                                    <el-option
                        ...
                        <div class="groupL">
                            ...
                            <div class="groupL-p">
                                ...
                                <i class="star-icon">*</i>
                                <el-input placeholder="请输入" @change="stageProceedsChange" v-model="stageProceeds" type="number" min="1"></el-input>
                            </div>
                            <div class="groupL-p">
                                <span class="f_l">到期日确定方式</span>
                                <i class="star-icon">*</i>
                                <el-select v-model="arrivalDateConfirm" @change="arrivalDateConfirmChange" filterable placeholder="请选择">
                                    <el-option
...
<script type="es6">
    ...
    export default {
        ...
        methods: {
            async saveContractTermLibrary(approvalStatus){//保存当前条款
                if(this.termName === ''){
                ...
                let data = {
                    ...
                    specialTermCategory: this.specialTermCategory,
                    approvalStatus,
                    addTermItemRelList: this.saveData
                }
                console.log(data)
                ...
                if(res.data.status.statusCode === 0){
                    this.$message('保存成功！')
                    setTimeout(() => {
                        this.removeTab('crm_termGlobalMain_newPaymentAgreement')
                    }, 3000)
                }else {
