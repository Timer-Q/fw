<template>
    <div class="wms-items">
        ...
        <div class="wms-modal-div clearfix">
            <div>
                <div class="btnGroup">
                    <el-button @click="addDemo">新增示例</el-button>
                </div>
                <div class="btnGroup">
                    <el-button @click="updateDemo">编辑示例</el-button>
                </div>
                <div class="btnGroup">
                    <el-button>导出入库通知单</el-button>
                </div>
                <div class="btnGroup">
                    <el-button>导出入库通知单明细</el-button>
                </div>
                <div class="btnGroup">
                        ...
                        <div class="details-list">
                            ...
                            <div class="information-list informationR-list">
                                <Table
                                    ...
                                    <TableColumn prop="throughput" label="整散转换" width=""></TableColumn>
                                    <TableColumn prop="notifyQty" label="通知数量" width=""></TableColumn>
...
<script>
    ...
    import newDemo from '@Wms/containers/demo/newDemo.vue'
