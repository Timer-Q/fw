    ...
    <div class="wms-items">
        <div v-loading.body="loading">
            ...
            <div class="wms-modal-div clearfix">
                <div>
                    <p class="btnGroup">
                        <a href="javascript:;" @click="allocate">分配确认</a>
                    </p>
                    <p class="btnGroup">
                        ...
                        <div class="vehicle-find">
                            <div class="vehicle-data">
                                ...
                                <div class="inblock">
                                    ...
                                    <el-select v-model="model.pickingUser" placeholder="全部">
                                        <el-option key="1" label="临时用户1" value="1">
                                        </el-option>
                                        <el-option key="2" label="临时用户2" value="2">
                                        </el-option>
                                    </el-select>
                                </div>
                            </div>
...
<script type="es6">
    import ElCascaderMenu from "../../../../../../node_modules/element-ui/packages/cascader/src/menu.vue"
