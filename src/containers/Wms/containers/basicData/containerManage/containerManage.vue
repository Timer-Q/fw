    ...
    <div class="wms-items">
        ...
        <div class="wms-modal-div clearfix">
            <div>
                ...
                <div class="btnGroup">
                    <el-button @click="forcedRelease">释放占用</el-button>
                </div>
                <div class="btnGroup">
                    <a href="javascript:;">打印条码</a>
                </div>
                <div class="btnGroup">
                    ...
                    <div class="vehicle-find">
                        <div class="vehicle-data">
                            <div class="inblock">
                                ...
                                <el-input type="text" class="license-number" v-model="listQueryParam.containerCode"></el-input>
                            </div>
                            <div class="inblock">
                                <span class="hspace">容器类别</span>
                                <el-select v-model="listQueryParam.containerCategory" placeholder="全部">
                                    <el-option
                            ...
                            <div class="inblock">
                                ...
                                <el-select v-model="listQueryParam.containerTypeId" placeholder="全部">
                                    <el-option
                            ...
                            <div class="inblock">
                                <span class="hspace">业务状态</span>
                                <el-select v-model="listQueryParam.operationStatus" placeholder="全部">
                                    <el-option
        ...
        <el-dialog title="弹窗示例" class="advancedQuery" :visible.sync="addVisible">
            ...
            <new-demo v-model="userId" @cancel="addVisible=false" @saved="addVisible=false"></new-demo>
...
<script type="es6">
    ...
    import newDemo from '@Wms/containers/basicData/containerManage/new.vue'
    ...
    let _this
    let api = {
        getlist: '/wms-base-server/container/getListWithPage'
    }
    ...
    export default {
        ...
        methods:{
            ...
            update() {
                alert(_this.container.containerCode)
                _this.userId = '123'
                _this.addVisible = true
            },
            del(){
...
//                    });
            ...
            startUsing(){
                ...
                _this.$request({
                    url: '/wms-base-server/container/startUsing',
                    context: _this,
                    sendData: requestData,
                    successCallback: (_this, response) => {
            ...
            blockUp(){
                ...
                _this.$request({
                    url: '/wms-base-server/container/blockUp',
                    context: _this,
                    sendData: requestData,
                    successCallback: (_this, response) => {
                        debugger
