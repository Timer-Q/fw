                ...
                <span class="el-dropdown-link">
                  查询方案<i class="iconfont icon-fangan"></i>
                    ...
                    <div class="information-list">
                        <Table :data="mainFormTableData" border style="width: 100%" :default-sort = "{prop: 'date', order: 'descending'}" >
                            <TableColumn prop="id" label="序号" width="70"></TableColumn>
                            <TableColumn type="selection" width="55"></TableColumn>
                            <TableColumn prop="" label="仓库"  width=""></TableColumn>
                            <TableColumn prop="" label="货主"  width=""></TableColumn>
                            <TableColumn prop="" label="库区"  width=""></TableColumn>
                            <TableColumn prop="" label="货位"  width=""></TableColumn>
                            ...
                            <TableColumn prop="" label="保质期天数" width=""> </TableColumn>
                            <TableColumn prop="" label="生产批号" width=""> </TableColumn>
                            <TableColumn prop="" label="整零转换" width=""> </TableColumn>
                            <TableColumn prop="" label="数量" width=""> </TableColumn>
                            <TableColumn prop="" label="单位" width=""> </TableColumn>
                            <TableColumn prop="" label="实物库存" width=""> </TableColumn>
                            <TableColumn prop="" label="可用库存" width=""> </TableColumn>
                            <TableColumn prop="" label="可销售库存" width=""> </TableColumn>
                            <TableColumn prop="" label="入位数量" width=""> </TableColumn>
                            <TableColumn prop="" label="出位数量" width=""> </TableColumn>
                            <TableColumn prop="" label="报损数量" width=""> </TableColumn>
                            <TableColumn prop="" label="报益数量" width=""> </TableColumn>
                            <TableColumn prop="" label="进货数量" width=""> </TableColumn>
                            <TableColumn prop="" label="销退数量" width=""> </TableColumn>
                            <TableColumn prop="" label="销售数量" width=""> </TableColumn>
                            <TableColumn prop="" label="退供数量" width=""> </TableColumn>
                            <TableColumn prop="" label="调拔出库数量" width=""> </TableColumn>
                            <TableColumn prop="" label="调拔入库数量" width=""> </TableColumn>
                            <TableColumn prop="" label="包装转换入数量" width=""> </TableColumn>
                            <TableColumn prop="" label="包装转换出数量" width=""> </TableColumn>
                            <TableColumn prop="" label="备注" width=""> </TableColumn>
                        </Table>
                    </div>
                    <!--主表单  end-->
                    <!--分页    start-->
        ...
        methods: {
          /*刷新*/
            ...
            handleSizeChange(val) {
                ...
                this.ReceivingDifferenceQuery.pageSize = val
            },
            handleCurrentChange(val) {
                console.log(`当前页: ${val}`)
                this.ReceivingDifferenceQuery.pageNumber = val
            },

            /*表单*/
            mainForm() {
                this.ReceivingDifferenceQuery.pageNumber = 1
                this.ReceivingDifferenceQuery.pageSize = 10
                this.ReceivingDifferenceQuery.pageStart = 0
                s.requestWMS({
                    type:'post',
                    url:this.mainFormUrl,
                    data:this.ReceivingDifferenceQuery,
                    headers:{
