                  ...
                  查询方案<i class="iconfont icon-fangan"></i>
                    ...
                    <div class="information-list">
                        <Table :data="mainFormTableData" highlight-current-row border style="width: 100%" :default-sort = "{prop: 'date', order: 'descending'}" >
                            ...
                            <TableColumn prop="orderOccuQty" label="订单占用" width=""> </TableColumn>
                            <TableColumn prop="tradeWarehouseOccuQty" label="移仓占用" width=""> </TableColumn>
                            <TableColumn prop="purchaseReturnOccuQty" label="退货占用" width=""> </TableColumn>
                            <TableColumn prop="transferBadOccuQty" label="转残占用" width=""> </TableColumn>
                            <TableColumn prop="transferGoodOccuQty" label="转正占用" width=""> </TableColumn>
                            <TableColumn prop="lossOccuQty" label="报损占用" width=""> </TableColumn>
...
<script type="es6">
    ...
    export default {
        ...
        data () {
            return {
                mainFormUrl:'/wms-inside-server/stbookownerlocationoccupation/getListWithPage',
                ...
                /*表单数据*/
                StbookOwnerLocationOccupationQuery :{
                    goodsQty: 0,
                    id: 0,
                    locationId: 0,
                    lossOccuQty: 0,
                    ...
                    pageSize: 0,
                    pageStart: 0,
                    purchaseReturnOccuQty: 0,
                    tradeWarehouseOccuQty: 0,
                    transferBadOccuQty: 0,
                    transferGoodOccuQty: 0,
                    warehouseId: 0,
                    warehouseareaId: 0
                },
                /*分页*/
        ...
        methods: {
            ...
            handleSizeChange(val) {
                ...
                this.StbookOwnerLocationOccupationQuery .pageSize = val
            },
            handleCurrentChange(val) {
                console.log(`当前页: ${val}`)
                this.StbookOwnerLocationOccupationQuery .pageNumber = val
            },

            /*表单*/
            mainForm() {
                this.StbookOwnerLocationOccupationQuery .pageNumber = 1
                this.StbookOwnerLocationOccupationQuery .pageSize = 10
                this.StbookOwnerLocationOccupationQuery .pageStart = 0
                s.requestWMS({
                    type:'post',
                    url:this.mainFormUrl,
                    data:this.StbookOwnerLocationOccupationQuery ,
                    headers:{
