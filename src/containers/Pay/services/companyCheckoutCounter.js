...
export default {
    queryStatus(data) {
        return new Promise(function (resolve, reject) {
            const url = `${config.server.http}${config.server.host}/pay-visit-web/pay/queryStatus`
    ...
    cyberBank(data) {
        return new Promise(function (resolve, reject) {
            const url = `${config.server.http}${config.server.host}/pay-visit-web/visit/cyberBank/pay`
            axios.post(url, data)
                .then(function (data) {
                    resolve(data)
                })
