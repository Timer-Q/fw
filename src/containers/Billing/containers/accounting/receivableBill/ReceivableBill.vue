...
// components
import receivableBillList from '@Billing/containers/accounting/receivableBill/receivableBillList/ReceivableBillList.vue'
import receivableBillDetail from '@Billing/containers/accounting/receivableBill/receivableBillDetail/ReceivableBillDetail.vue'
import newBillList from '@Billing/containers/accounting/receivableBill/newBillList/NewBillList.vue'
export default {
