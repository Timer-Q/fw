    ...
    <section class="invoicing billing-form-inline">
        ...
        <el-form :inline="true" :model="formData" :rules="VATComputed" ref="paymentBillDetalForm">
            ...
            <el-form-item label="单据状态" prop="billStatus">
                    ...
                    <div class="popover-content">
                        <div class="popover-content-item">
                            ...
                            <div class="popover-content-row">
                                ...
                                <span>
                                    <el-checkbox label="是否已全部暂估回冲" name="type"></el-checkbox>
                                </span>
                                <span>
                                    <el-checkbox label="是否推式生单" name="type"></el-checkbox>
                                </span>
                            </div>
                        </div>
                        <div class="popover-content-item">
                ...
                <i class="el-icon-document popover-trigger-icon" v-popover:billingpopover></i>
            </el-form-item>
