...
例如：" type="error" :closable="false">
            ...
            <el-tab-pane name="demo" label="demo">
                <!--@remoteMethod="destinationRemoteMethod"-->
                ...
                >
                    <template slot-scope="scope">
                        <!--<span style="float: left">{{ scope.row.value }}</span>-->
                        <!--<span style="float: right; color: #8492a6; font-size: 13px">{{ scope.$index }}</span>-->
                        <el-button @click="destName='a'+Math.random()">点击修改value</el-button>
                ...
                <fw-smarter-input-select
                    ...
                    :loading="isLoadingDestination"
                    :value="destName"
                    labelKey="nestedValue.value"
                    isShowKey="isShow"
                >
                    <template slot-scope="scope">
                        <span style="float: left">{{ scope.row.nestedValue.value }}</span>
                        <span style="float: right; color: #8492a6; font-size: 13px">{{ scope.$index }}</span>
                    </template>
                ...
                <fw-smarter-input-select
                    ...
                    option-facade="TABLE"
                    table-row-labels="test1 test2 a b"
                    table-row-props="label nestedValue.value a b"
                    table-row-widths="100 50"
                    isShowKey="isShow"
                >
                ...
                <!--destName:'default value',-->

                <fw-vm-data-viewer :vm="_self" :keys="'destinationData isLoadingDestination destName'.split(' ')"></fw-vm-data-viewer>
