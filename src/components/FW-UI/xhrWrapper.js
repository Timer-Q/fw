    ...
    callInterfaceAndSetData(requestParam,setObj=null,modelStr,cache=false){
        return s.request(requestParam,cache)
            .then(([resData])=>{
                ...
                console.log('call interface e:',e)
                if(setObj){
    ...
    request:(function(){
        ...
        return function (arg,cache=false,alertError=true) {
            ...
            return Promise.all(promiseArr).then((res) => {
                ...
                // console.log('finally reqResult--- then--:',reqResult)
                ...
                .catch((e) => {
                    ...
                    // console.log('finally reqResult--- catch--:',reqResult)

                    throw e

                })
            // .finally(()=>{
            //     console.log('finally reqResult--:',reqResult)
            // })
            // return result
        }
    })(),
